package com.yago.aprendo.spring.data.infrastructure.security;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    @Autowired
    private com.yago.aprendo.spring.data.infrastructure.repository.UsuarioRepository usuarioRepository;

    // Implementação do método para carregar detalhes do usuário pelo e-mail
    @Override
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        // Busca o usuário no banco de dados pelo e-mail
        com.yago.aprendo.spring.data.infrastructure.entity.Usuario usuario = usuarioRepository.findByEmail(email)
